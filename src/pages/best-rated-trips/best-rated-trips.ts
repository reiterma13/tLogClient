...
/*
  Generated class for the BestRatedTrips page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-best-rated-trips',
  templateUrl: 'best-rated-trips.html'
})
export class BestRatedTripsPage {
  selectedItem: any;
  icons: string[];
  items: Array<Trip>;
  ...
  likeTrip(tripID,liked){
    ...
    this.navCtrl.push(BestRatedTripsPage, {
    });
  }
